# SeedScout ATS Production Starter

SeedScout is a founder-focused ATS for early teams. This production starter is designed for:
...
5. Run the SQL in `supabase/schema_easy_setup.sql` inside Supabase SQL Editor.
6. Run `npm run dev`.
